...
BEGIN
  ...
  */
  ...
  BEGIN
    ...
    END;
    BEGIN
    CREATE TEMPORARY TABLE `WORKFLOW_236dfc12072ff54c_5f5f88ac3865c57c_result`
    AS
    ...
    END;
    BEGIN
    CREATE TEMPORARY TABLE `WORKFLOW_236dfc12072ff54c_077e78e3a873fbbe_result`
    AS
      SELECT
        *,
        CASE
        ...
        ELSE 'After'
        END AS period
      FROM `WORKFLOW_236dfc12072ff54c_5f5f88ac3865c57c_result`;
    END;
    BEGIN
    CREATE TEMPORARY TABLE `WORKFLOW_236dfc12072ff54c_aa9cb76ca4760b2e_result`
    AS
      SELECT period,
        SUM(vol_joined) vol_joined_sum
      FROM `WORKFLOW_236dfc12072ff54c_077e78e3a873fbbe_result`
      GROUP BY period;
    END;
    BEGIN
    ...
    END;
    BEGIN
    CREATE TEMPORARY TABLE `WORKFLOW_236dfc12072ff54c_82022f0d537a187b_result`
    AS
    ...
    END;
    BEGIN
    CREATE TEMPORARY TABLE `WORKFLOW_236dfc12072ff54c_4982c340bc88ee78_result`
    AS
    ...
    END;
    BEGIN
    CREATE TEMPORARY TABLE `WORKFLOW_236dfc12072ff54c_323ec044b48d7290_result`
    AS
      SELECT
        *,
        CASE
        ...
        ELSE 'After'
        END AS period
      FROM `WORKFLOW_236dfc12072ff54c_82022f0d537a187b_result`;
    END;
    BEGIN
    CREATE TEMPORARY TABLE `WORKFLOW_236dfc12072ff54c_7cb9d7ef9b4990e6_result`
    AS
      SELECT period,
        COUNT(collision_id) collision_id_count
      FROM `WORKFLOW_236dfc12072ff54c_323ec044b48d7290_result`
      GROUP BY period;
    END;
    BEGIN
    CREATE TEMPORARY TABLE `WORKFLOW_236dfc12072ff54c_eb80b3929a300da0_result`
    AS
      SELECT
        *,
        CASE
        ...
        ELSE 'After'
        END AS period
      FROM `WORKFLOW_236dfc12072ff54c_4982c340bc88ee78_result`;
    END;
    BEGIN
    CREATE TEMPORARY TABLE `WORKFLOW_236dfc12072ff54c_644037220accf344_result`
    AS
      SELECT period,
        AVG(value) value_avg
      FROM `WORKFLOW_236dfc12072ff54c_eb80b3929a300da0_result`
      GROUP BY period;
    END;
    BEGIN
    CREATE TEMPORARY TABLE `WORKFLOW_236dfc12072ff54c_2251a673330075d2_result`
    AS
      SELECT 
        _main.*,
        _joined.period AS period_joined, _joined.collision_id_count AS collision_id_count_joined
      FROM
        `WORKFLOW_236dfc12072ff54c_aa9cb76ca4760b2e_result` AS _main
      RIGHT JOIN
        `WORKFLOW_236dfc12072ff54c_7cb9d7ef9b4990e6_result` AS _joined
      ON
        _main.period = _joined.period;
    END;
    BEGIN
    CREATE TEMPORARY TABLE `WORKFLOW_236dfc12072ff54c_e8e0b5a1f0f441c1_result`
    AS
      SELECT
      ...
      FROM `WORKFLOW_236dfc12072ff54c_2251a673330075d2_result`;
    END;
    BEGIN
    CREATE TEMPORARY TABLE `WORKFLOW_236dfc12072ff54c_bd7493dd593d160a_result`
    AS
      SELECT 
        _main.*,
        _joined.period AS period_joined, _joined.value_avg AS value_avg_joined
      FROM
        `WORKFLOW_236dfc12072ff54c_e8e0b5a1f0f441c1_result` AS _main
      RIGHT JOIN
        `WORKFLOW_236dfc12072ff54c_644037220accf344_result` AS _joined
      ON
        _main.period = _joined.period;
    END;
    BEGIN
    CREATE TEMPORARY TABLE `WORKFLOW_236dfc12072ff54c_34922bfa12418f49_result`
    AS
      SELECT
        SAFE_CAST(period_joined AS STRING) AS period,
      ...
      FROM `WORKFLOW_236dfc12072ff54c_bd7493dd593d160a_result`;
    END;
    EXECUTE IMMEDIATE
    REPLACE(
