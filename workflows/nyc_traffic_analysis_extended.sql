...
BEGIN
  ...
  */
  ...
  BEGIN
    ...
    END;
    BEGIN
    CREATE TEMPORARY TABLE `WORKFLOW_f974f3bfabe773d6_e984fef92c2752fe_result`
    AS
      SELECT 
        _left.total_collisions AS total_collisions, _left.total_traffic_counts AS total_traffic_counts, _right.value_avg AS avg_air_quality
      FROM
