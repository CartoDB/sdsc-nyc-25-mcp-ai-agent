...
BEGIN
  ...
  */
  ...
  END;
  BEGIN
  CREATE TEMPORARY TABLE `WORKFLOW_c3b932854a8512b2_72f1e07c7aea5cea_result`
  AS
    SELECT period,
      AVG(vol_joined) vol_joined_avg
  ...
  END;
  BEGIN
  CREATE TEMPORARY TABLE `WORKFLOW_c3b932854a8512b2_3a7f95fe99d1d8f4_result`
  AS
    SELECT
      SAFE_CAST(period_joined AS STRING) AS period,
      SAFE_CAST(vol_joined_avg AS FLOAT64) AS avg_daily_traffic,
      SAFE_CAST(collision_id_count_joined AS FLOAT64) AS total_collisions
    FROM `WORKFLOW_c3b932854a8512b2_4f39468315b94092_result`;
  END;
  BEGIN
  CREATE TEMPORARY TABLE `WORKFLOW_c3b932854a8512b2_ebc3b9d4adbe186e_result`
  AS
    SELECT
      SAFE_CAST(period_joined AS STRING) AS period,
      SAFE_CAST(value_avg_joined AS FLOAT64) AS avg_polution,
      SAFE_CAST(avg_daily_traffic AS FLOAT64) AS avg_daily_traffic,
      SAFE_CAST(total_collisions AS FLOAT64) AS total_collisions
    FROM `WORKFLOW_c3b932854a8512b2_91711fcf76a4d29e_result`;
  END;
END;